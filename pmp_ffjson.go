...
func (j *Deal) MarshalJSON() ([]byte, error) {
...
func (j *Deal) MarshalJSONBuf(buf fflib.EncodingBuffer) error {
	if j == nil {
		buf.WriteString("null")
		return nil
	}
...
var ffjKeyDealID = []byte("id")

var ffjKeyDealBidFloor = []byte("bidfloor")

var ffjKeyDealBidFloorCurrency = []byte("bidfloorcur")

var ffjKeyDealWSeat = []byte("wseat")

var ffjKeyDealWAdvDomain = []byte("wadomain")

var ffjKeyDealAuctionType = []byte("at")

var ffjKeyDealExt = []byte("ext")

var ffjKeyDealSeats = []byte("seats")

var ffjKeyDealType = []byte("type")

// UnmarshalJSON umarshall json - template of ffjson
func (j *Deal) UnmarshalJSON(input []byte) error {
	fs := fflib.NewFFLexer(input)
	return j.UnmarshalJSONFFLexer(fs, fflib.FFParse_map_start)
}

// UnmarshalJSONFFLexer fast json unmarshall - template ffjson
func (j *Deal) UnmarshalJSONFFLexer(fs *fflib.FFLexer, state fflib.FFParseState) error {
	var err error
	currentKey := ffjtDealbase
	_ = currentKey
	...
	for {
		...
		case fflib.FFParse_want_key:
			...
			if len(kn) <= 0 {
				...
				case 'a':
					...
					if bytes.Equal(ffjKeyDealAuctionType, kn) {
						currentKey = ffjtDealAuctionType
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'b':
					...
					if bytes.Equal(ffjKeyDealBidFloor, kn) {
						currentKey = ffjtDealBidFloor
						state = fflib.FFParse_want_colon
						goto mainparse

					} else if bytes.Equal(ffjKeyDealBidFloorCurrency, kn) {
						currentKey = ffjtDealBidFloorCurrency
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'e':
					...
					if bytes.Equal(ffjKeyDealExt, kn) {
						currentKey = ffjtDealExt
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'i':
					...
					if bytes.Equal(ffjKeyDealID, kn) {
						currentKey = ffjtDealID
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 's':
					...
					if bytes.Equal(ffjKeyDealSeats, kn) {
						currentKey = ffjtDealSeats
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 't':
					...
					if bytes.Equal(ffjKeyDealType, kn) {
						currentKey = ffjtDealType
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'w':
					...
					if bytes.Equal(ffjKeyDealWSeat, kn) {
						currentKey = ffjtDealWSeat
						state = fflib.FFParse_want_colon
						goto mainparse

					} else if bytes.Equal(ffjKeyDealWAdvDomain, kn) {
						currentKey = ffjtDealWAdvDomain
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				if fflib.SimpleLetterEqualFold(ffjKeyDealType, kn) {
					currentKey = ffjtDealType
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeyDealSeats, kn) {
					currentKey = ffjtDealSeats
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.SimpleLetterEqualFold(ffjKeyDealExt, kn) {
					currentKey = ffjtDealExt
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.SimpleLetterEqualFold(ffjKeyDealAuctionType, kn) {
					currentKey = ffjtDealAuctionType
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.SimpleLetterEqualFold(ffjKeyDealWAdvDomain, kn) {
					currentKey = ffjtDealWAdvDomain
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeyDealWSeat, kn) {
					currentKey = ffjtDealWSeat
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.SimpleLetterEqualFold(ffjKeyDealBidFloorCurrency, kn) {
					currentKey = ffjtDealBidFloorCurrency
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.SimpleLetterEqualFold(ffjKeyDealBidFloor, kn) {
					currentKey = ffjtDealBidFloor
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.SimpleLetterEqualFold(ffjKeyDealID, kn) {
					currentKey = ffjtDealID
					state = fflib.FFParse_want_colon
					goto mainparse
				}
		...
		case fflib.FFParse_want_value:
			...
			if tok == fflib.FFTok_left_brace || tok == fflib.FFTok_left_bracket || tok == fflib.FFTok_integer || tok == fflib.FFTok_double || tok == fflib.FFTok_string || tok == fflib.FFTok_bool || tok == fflib.FFTok_null {
				...
				case ffjtDealBidFloor:
					goto handle_BidFloor

				case ffjtDealBidFloorCurrency:
					goto handle_BidFloorCurrency

				case ffjtDealWSeat:
					goto handle_WSeat

				case ffjtDealWAdvDomain:
					goto handle_WAdvDomain

				case ffjtDealAuctionType:
...
handle_Private:
	...
	/* handler: j.Private type=int kind=int quoted=false*/
			...
			for {
...

				{
					if tok == fflib.FFTok_null {
						...
						err = tmpJDeals.UnmarshalJSONFFLexer(fs, fflib.FFParse_want_key)
						if err != nil {
							return err
						}
					}
